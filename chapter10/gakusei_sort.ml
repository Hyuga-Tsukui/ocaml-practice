...
(* tests *)
let test1 =
  gakusei_insert lst1 { namae = "hyuga"; tensuu = 69; seiseki = "C" }
  = [ { namae = "hyuga"; tensuu = 69; seiseki = "C" } ]
;;

let test2 =
  gakusei_insert lst2 { namae = "hyuga"; tensuu = 69; seiseki = "C" }
  = [ { namae = "hyuga"; tensuu = 69; seiseki = "C" }
    ; { namae = "asai"; tensuu = 70; seiseki = "B" }
    ]
;;
