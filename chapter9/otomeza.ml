...
let seiza m d =
  if (m = 3 && 21 <= d) || (m = 4 && d <= 19)
  then aries
  else if (m = 4 && 20 <= d) || (m = 5 && d <= 20)
  then taurus
  else if (m = 5 && 21 <= d) || (m = 6 && d <= 21)
  then gemini
  else if (m = 6 && 22 <= d) || (m = 7 && d <= 22)
  then cancer
  else if (m = 7 && 23 <= d) || (m = 8 && d <= 22)
  then leo
  else if (m = 8 && 23 <= d) || (m = 9 && d <= 22)
  then virgo
  else if (m = 9 && 23 <= d) || (m = 10 && d <= 23)
  then libra
  else if (m = 10 && 24 <= d) || (m = 11 && d <= 22)
  then scorpius
  else if (m = 11 && 23 <= d) || (m = 12 && d <= 21)
  then sagittarius
  else if (m = 12 && 22 <= d) || (m = 1 && d <= 19)
  then capricorunus
  else if (m = 1 && 20 <= d) || (m = 2 && d <= 18)
  then aquarius
  else if (m = 2 && 19 <= d) || (m = 3 && d <= 20)
  then pisces
  else "unknown"
;;
...
let rec otomeza lst =
  match lst with
  | [] -> []
  | { birth = m, d; name = n } :: rest ->
    if seiza m d = virgo then n :: otomeza rest else otomeza rest
;;
